...
import static com.termux.shared.termux.TermuxConstants.TERMUX_API_CODE_PACKAGE_NAME;
...
public class TermuxAPIConstants {
     ...
     */
    public static final String TERMUX_API_RECEIVER_NAME = TERMUX_API_CODE_PACKAGE_NAME + ".TermuxApiReceiver"; // Default to "com.termux.api.TermuxApiReceiver"
